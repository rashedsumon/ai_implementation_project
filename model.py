...
class SupportAIModelPipeline:
    def __init__(self):
        # Establish base model config explicitly requesting pure JSON answers
        self.llm = ChatGoogleGenerativeAI(
            model="gemini-1.5-flash",
            temperature=0.1
        )
        
        # Local, reliable embedding module
    ...
    def get_llm_processor_node(self, state: AgentState) -> Dict[str, Any]:
        ...
        # Clean text boundaries in case markdown fences are generated by default
        ...
        try:
            ...
            # Absolute baseline operational fallback data map in case raw JSON parsing fragments
            output_dict = {
